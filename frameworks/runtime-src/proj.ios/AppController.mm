...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	//广告统计sdk
	[[BoyaaADSDK instance]initAppFlyerWithKey:@"x7Px3ea6x8SZpwFf7xSWJg" andAppleItunesID:@"1029020372"];
	[BoyaaADSDK instance].isDebug = NO;
...
//    [self startCocos2dx];
	...
	if ([@"com.boyaa.pokdeng" isEqualToString:bundleId] ) {
		[XGPush startApp:2200138671 appKey:@"IY2KP4936PTU"];
	} else if ([@"com.boyaa.pokdeng.vn" isEqualToString:bundleId]) {
		[XGPush startApp:2200138671 appKey:@"IY2KP4936PTU"];
	} else if ([@"com.boyaa.pokdeng.en" isEqualToString:bundleId]) {
		[XGPush startApp:2200138671 appKey:@"IY2KP4936PTU"];
	}
	//注销之后需要再次注册前的准备
	void (^successCallback)(void) = ^(void) {
		[XGPush setAccount:@"vanfo"];
		//如果变成需要注册状态
