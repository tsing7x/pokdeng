...
public class Request {
     ...
     * add by freddy
     */
    public static Request newMyFriendsRequestForDetail(Session session, Bundle parameters, final GraphUserListCallback callback){
    	Callback wrapper = new Callback() {
            @Override
            public void onCompleted(Response response) {
                if (callback != null) {
        ...
        return new Request(session, MY_FRIENDS, parameters, null, wrapper);
    }
