...
local CardTypePopup = import("app.module.grabDealer.room.views.GrabCardTypePopup")
...
function GrabDealerRoomScene:onReviewClick_()
    GameReviewPopup.new():show()
end
function GrabDealerRoomScene:onRecordClick_()
...
function GrabDealerRoomScene:onLoadedHallTexture_()
...
function GrabDealerRoomScene:onLoadedHallTextureLogout_()
