...
-- --
-- local ChooseMatchRoomChip = class("ChooseMatchRoomChip", function ()
--     return display.newNode()
-- end)

-- function ChooseMatchRoomChip:ctor(chipSkin, textColor,nameSkin)
...
--     self.playerCountLabel_ = display.newTTFLabel({text = "123456", color = cc.c3b(0xFF, 0xED, 0xA4), size = 18, align = ui.TEXT_ALIGN_CENTER})
...
-- function ChooseMatchRoomChip:onTouch_(evt)
...
-- function ChooseMatchRoomChip:setPreCall(val)
--     self.preCall_ = val
...
-- function ChooseMatchRoomChip:getValue()
--     return (self.preCall_ and self.preCall_[2] or 0)
-- end


-- function ChooseMatchRoomChip:updateBaseInfo(data)
--     self.baseData_ = data
--     dump(data,"ChooseMatchRoomChip:updateBaseInfo")
...
-- function ChooseMatchRoomChip:getBaseInfo()
--     return self.baseData_
-- end

-- function ChooseMatchRoomChip:loadImageTexture(data)
...
-- function ChooseMatchRoomChip:onAvatarLoadComplete_1(success, sprite)
--     -- do return end
--     if success then
--         self.icon1_:show()
...
-- function ChooseMatchRoomChip:onAvatarLoadComplete_2(success, sprite)
--     if success then
--         self.icon2_:show()
--          local tex = sprite:getTexture()
--          local texSize = tex:getContentSize()
...
-- function ChooseMatchRoomChip:onAvatarLoadComplete_3(success,sprite)
--     if success then
...
--     end
-- end
-- function ChooseMatchRoomChip:onAvatarLoadComplete_4(success,sprite)
--     if success then
...
-- function ChooseMatchRoomChip:onChipClick(callback)
