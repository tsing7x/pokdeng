...
local DealerPaoPaoTip = class("DealerPaoPaoTip", 
function() 
	return display.newNode() 
end)

function DealerPaoPaoTip:ctor()
	
end

function DealerPaoPaoTip:createNode_(data)
...
function DealerPaoPaoTip:cleanNode_()
	if self.txt_ then
...
function DealerPaoPaoTip:show(data)
	self:createNode_(data)
end

function DealerPaoPaoTip:onCleanup()

end
function DealerPaoPaoTip:getWidth()
	return self.width_
end

return DealerPaoPaoTip