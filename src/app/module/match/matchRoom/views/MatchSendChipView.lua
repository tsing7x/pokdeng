...
--
local MatchSendChipView = class("MatchSendChipView", function() return display.newNode() end)

function MatchSendChipView:ctor(chips)
    ...
    self.label_ = display.newTTFLabel({text = bm.formatBigNumber(chips), size = 20, align = ui.TEXT_ALIGN_CENTER, color = cc.c3b(255, 204, 0)})
            :addTo(self)
