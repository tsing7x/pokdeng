...
function MatchSeatView:ctor(ctx, seatId)
    ...
    --7 座位筹码文字
    self.chips_ = display.newTTFLabel({text = "", size = 24, align = ui.TEXT_ALIGN_LEFT, color=cc.c3b(0xff, 0xd1, 0x00)})
        :pos(chipIconX+10, -66)
...
function MatchSeatView:userImageLoadCallback_(success, sprite)
