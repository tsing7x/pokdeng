...
--
local MatchRoomSignalIndicator = class("MatchRoomSignalIndicator", function() return display.newNode() end)

function MatchRoomSignalIndicator:ctor()
...
function MatchRoomSignalIndicator:setSignalStrength(strength)
...
function MatchRoomSignalIndicator:flash_(isFlash)
...
return MatchRoomSignalIndicator