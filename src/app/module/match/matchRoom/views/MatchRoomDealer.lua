...
local MatchRoomDealer = class("MatchRoomDealer", function ()
    return display.newNode()
end)

function MatchRoomDealer:ctor(dealerId)
...
function MatchRoomDealer:blinkTwoEyes_()
...
-- 亲嘴玩家
function MatchRoomDealer:kissPlayer()
    -- 先眨眼
...
-- 敲桌子
function MatchRoomDealer:tapTable()
