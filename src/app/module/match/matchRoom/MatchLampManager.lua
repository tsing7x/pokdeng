...
--
local MatchLampManager = class("MatchLampManager")
local RoomViewPosition = import(".views.MatchRoomViewPosition")
local log = bm.Logger.new("MatchLampManager")

function MatchLampManager:ctor()
end

function MatchLampManager:createNodes()
...
function MatchLampManager:show()
    self.lamp_:show()
end

function MatchLampManager:hide()
    self.lamp_:hide()
end

function MatchLampManager:getPositionId()
    return self.lampPostionId_ or 1
end

function MatchLampManager:turnTo(positionId, animation)
...
function MatchLampManager:setLampRotation(animation, rotation, scale)
...
function MatchLampManager:dispose()
end

return MatchLampManager