...
function FeedbackListItem:ctor()
    ...
    -- print("FeedbackListItem.WIDTH ", FeedbackListItem.WIDTH)
    -- print("FeedbackListItem.HEIGHT ", FeedbackListItem.HEIGHT)
    ...
    self.questionLabel = display.newTTFLabel({
            ...
            dimensions = cc.size(FeedbackListItem.WIDTH - labelSizePadding, 0)
        })
