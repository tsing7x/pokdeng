...
local GrabExpressionConfig = class("GrabExpressionConfig")

function GrabExpressionConfig:ctor()
    self.config_ = {}
...
function GrabExpressionConfig:getConfig(id)
    return self.config_[id]
end

function GrabExpressionConfig:addConfig_(id, frameNum, adjustX, adjustY)
    local config = {}
    config.id = id
