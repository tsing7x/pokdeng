...
local GrabRoomChatBubble = class("GrabRoomChatBubble", function() return display.newNode() end)

GrabRoomChatBubble.DIRECTION_LEFT = 1
GrabRoomChatBubble.DIRECTION_RIGHT = 2

function GrabRoomChatBubble:ctor(label, direction)
    if direction == GrabRoomChatBubble.DIRECTION_LEFT then
...
function GrabRoomChatBubble:show(parent, x, y)
