...
--
local GrabRoomSignalIndicator = class("GrabRoomSignalIndicator", function() return display.newNode() end)

function GrabRoomSignalIndicator:ctor()
...
function GrabRoomSignalIndicator:setSignalStrength(strength)
...
function GrabRoomSignalIndicator:flash_(isFlash)
...
return GrabRoomSignalIndicator