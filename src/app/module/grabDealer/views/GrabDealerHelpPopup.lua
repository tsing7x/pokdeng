local GrabDealerHelpPopup = class("GrabDealerHelpPopup", nk.ui.Panel)

local WIDTH = 725
local HEIGHT = 445

function GrabDealerHelpPopup:ctor()
...
function GrabDealerHelpPopup:show()
	-- body
	self:showPanel_()
end

function GrabDealerHelpPopup:onShowed()
	-- body
	
end

return GrabDealerHelpPopup