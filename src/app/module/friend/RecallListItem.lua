...
local RecallListItem = class("RecallListItem", function ()
    return display.newNode()
end)

RecallListItem.ITEM_WIDTH = 238
RecallListItem.ITEM_HEIGHT = 90

function RecallListItem:ctor(data, owner, popup, index)
...
function RecallListItem:createContent_()
...
function RecallListItem:lazyCreateContent()
...
function RecallListItem:onItemDeactived()
...
function RecallListItem:onAvatarLoadComplete_(success, sprite)
    if success then
...
function RecallListItem:onBgTouch_(target, evtName)
...
function RecallListItem:getData()
    return self.data_
end

function RecallListItem:isSelected()
    return self.isSelected_
end

function RecallListItem:setSelected(isSelected)
