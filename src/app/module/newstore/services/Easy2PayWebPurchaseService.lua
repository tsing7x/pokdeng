...
local Easy2PayWebPurchaseService = class("Easy2PayWebPurchaseService", import("app.module.newstore.PurchaseServiceBase"))
...
function Easy2PayWebPurchaseService:showPayWebView(webUrl)
    ...
    if not self.webView_ then
        ...
        local webViewBg = display.newColorLayer(cc.c4b(0, 0, 0, 128)):addTo(self.webView_)
