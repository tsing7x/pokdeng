...
local GetedRewardDialog = class("GetedRewardDialog", Panel)
...
function GetedRewardDialog:ctor(parent)
    self.parent_ = parent
     cc.Director:getInstance():getTextureCache():removeUnusedTextures()
     self:setNodeEventEnabled(true)
     self:setTouchSwallowEnabled(false)
	 GetedRewardDialog.super.ctor(self, {580,400})
     self:addCloseBtn()--
...
function GetedRewardDialog:onButtonClick_()
...
function GetedRewardDialog:show(seedType)
